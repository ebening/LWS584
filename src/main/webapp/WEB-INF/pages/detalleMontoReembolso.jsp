					...
					<div class="dataTable_wrapper scrollable">
						<table class="table table-striped table-bordered table-hover"
							...
							<tr>
								...
								<td style="border: none; text-align: right">$<span class="currencyFormat" id="totalesReembolsos"></span></td>
								<td style="border: none;">&nbsp;</td>
								<td style="border: none;">&nbsp;</td>
								<td style="border: none;">&nbsp;</td>
								<td style="border: none;">&nbsp;</td>
								<th style="border: none; text-align: right">$<span class="currencyFormat" id="ivaReembolsos"></span></th>
								<th style="border: 0; text-align: right">$<span class="currencyFormat" id="iepsReembolsos"></span></th>
							</tr>
							<tr>
								<td style="border: none"></td>
								<td style="border: none"></td>
								...
								<td style="border: none"></td>
								<td style="border: none"></td>
								<th style="border: none"><%=etiqueta.REEMBOLSO_TOTAL%></th>
								<td style="border: none"></td>
